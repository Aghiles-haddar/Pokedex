...
import pokemon8 from '../../Assets/pokemon8.png'

function Stronger(){
    return(
        <div className="container-global-legendarie stronger">

            <div className="container-title-legendarie">
                <h1 className="legendarie-h1">Stronger</h1>
                <div className="lengendarie-separator"></div>
            </div>

            <div className="information-lengendarie">
                <div className="information-left-legendarie">
                    <img className="mewtwo" src={pokemon8} alt="" />
                </div>
                <div className="information-right-legendarie">
                    <h1 className="right-title">Dragonair</h1>
